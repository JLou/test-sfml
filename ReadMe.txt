========================================================================
   APPLICATION CONSOLE : Vue d'ensemble du projet zeldaliketest
========================================================================

AppWizard a créé cette application zeldaliketest pour vous.

Ce fichier contient un résumé des éléments contenus dans chaque fichier qui
constitue votre application zeldaliketest.


zeldaliketest.vcxproj
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) nommé zeldaliketest.pch et un fichier de types précompilés 
    nommé StdAfx.obj.
